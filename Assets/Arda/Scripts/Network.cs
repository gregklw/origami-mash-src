...
public class Network : NetworkManager
{
    ...
    {
        /*ProgressManager.instance.players.Clear();
        ProgressManager.instance.playerList.Clear();        
        //if(ProgressManager.instance.numberOfPlayersLeft > 0)
        //ProgressManager.instance.numberOfPlayersLeft--;
        ProgressManager.instance.numberOfPlayersLeft = 0;
        ProgressManager.instance.CancelInvoke("Timer");
        LobbyManager.instance.playerNumber = 0;
        ...
        Camera.main.transform.localPosition = new Vector3(-7.9f, 9.4f, -387.1f);
    ...
    public override void OnStopHost()
    {
        ...
        ProgressManager.instance.numberOfPlayersLeft = 0;
        ProgressManager.instance.CancelInvoke("Timer");
        ProgressManager.instance.timer = 100;
        LobbyManager.instance.BackToLobby();
        LobbyManager.instance.playerNumber = 0;
        LobbyManager.instance.numberOfPlayers = 0;
        LobbyManager.instance.gameStarted = false;
        TsunamiSpawner.instance.CancelInvoke("Timer");
        TsunamiSpawner.instance.CancelInvoke("SpawnTsunami");
        TsunamiSpawner.instance.counter = 50;
